...
Next time, we're going to dive into the link:{% link _posts/2020-02-18-practical-problem-solving-advent-of-code-not-quite-lisp.adoc %}[first Advent of Code challenge].
