= Practical Problem Solving: Doesn't He Have Intern-Elves For This?
:page-layout: post
...
I am sure they will be handy with future challenges, and it's always great to get some practice slinging regular expressions in the programming languge you're using.
